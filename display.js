// Método auxiliar para crear elementos
const SCALE = 30
...
function DOMDisplay(parent, level) {
	this.wrap = parent.appendChild(createElement('div', 'game')); // A un elemento html, le añade un hijo body
	this.level = level;
...
DOMDisplay.prototype.drawBackground = function () {
	...
	table.style.width = this.level.width * SCALE + 'px'; // Longitud del nivel
